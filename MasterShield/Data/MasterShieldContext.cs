...
public class MasterShieldContext : IdentityDbContext<User, IdentityRole<Guid>, Guid>
{
    private static readonly JsonSerializerOptions JsonOptions = new(JsonSerializerDefaults.Web);

    public MasterShieldContext(DbContextOptions<MasterShieldContext> options) : base(options) { }
