...
public class RuleService : MasterShieldContextService, IRuleService
{
    private readonly IBlueprintService _blueprints;

    public RuleService(MasterShieldContext context, IBlueprintService blueprints) : base(context)
    {
