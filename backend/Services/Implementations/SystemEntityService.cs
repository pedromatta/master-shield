...
/// </summary>
public class SystemEntityService : DaedalaContextService, ISystemEntityService
{
    private readonly IBlueprintService _blueprints;

    public SystemEntityService(DaedalaContext context, IBlueprintService blueprints)
        : base(context)
    {
