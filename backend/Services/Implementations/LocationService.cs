...
public class LocationService : DaedalaContextService, ILocationService
{
    public LocationService(DaedalaContext context) : base(context) { }
...
public class CounterService : DaedalaContextService, ICounterService
{
    public CounterService(DaedalaContext context) : base(context) { }
...
public class TagService : DaedalaContextService, ITagService
{
    public TagService(DaedalaContext context) : base(context) { }
